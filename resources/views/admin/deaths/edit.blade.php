        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                 <div class="row">
                        <div class="col-md-6">
                            <form action="{{route('d.update',[$death->id])}}" method="POST">
                                @csrf
                                {{-- Death name --}}
                                <div class="form-group">
                                 <label for="title" class="form-label">name</label>
                                 <input type="text" class="form-control" name="name" value="{{$death->name}}">
                                 {{-- Gender  --}}
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <input type="date" class="form-control" name="dateofdeath" value="{{$death->dateofdeath}}" >
                                 {{-- Hospital name --}}
                                <div class="form-group">
                             ...
                             <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="city_id" >
                                        <option  value="Choose Category"> Choose City</option>
                                ...
                                <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="reason" value="{{$death->reason}}" >
                                </div>
